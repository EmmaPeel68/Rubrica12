...
public class Repository_Author extends Repository{
...
public void insert_Author(Author author) {
	...
	public ArrayList<Author> find_Authors(Author author) {
		...
		try {
			...
			preparedStatement.setDate(1, (Date) author.getDateOfBirth());
	...
	public ArrayList<Author> find_Authors_ByDate(Date date) {
		ArrayList<Author> list = new ArrayList<Author>();
